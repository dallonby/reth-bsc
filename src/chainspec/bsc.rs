...
mod tests {
    ...
    fn can_create_forkid() {
        ...
        // The next fork after head() (timestamp 1751250600, which is Maxwell fork) is Fermi at 1768357800
        let expected_f_id = ForkId { hash: ForkHash(expected), next: 1768357800 };
